...
/*Phần này bổ sung cho GUI mà thôi*/
...
void InterbotixMoveItInterface::add_a_Box(void)
{
  ...
  box_primitive.dimensions[box_primitive.BOX_X] = 0.02;
  box_primitive.dimensions[box_primitive.BOX_Y] = 0.02;
  box_primitive.dimensions[box_primitive.BOX_Z] = 0.02;
...
void InterbotixMoveItInterface::attach_object(void)
{
  move_group->attachObject("vat_the_gap", move_group->getEndEffectorLink().c_str());
}
